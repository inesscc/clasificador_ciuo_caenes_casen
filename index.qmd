...
- Para clonar el repositorio no es necesario tener una cuenta gitlab.
...
``` console                                                  
git clone http://gitlabsdti.ine.cl/sdt/ciencia-de-datos/colaboracion-mdsf/clasificador_ciuo_caenes_casen.git
...
- Crear el ambiente virtual y activarlo usando los siguientes comandos:
...
``` 
- Este paso puede demorar un poco
...
- Las bases, los modelos y artefactos para correr el flujo se encuentran en el siguiente link: 
...
- Luego los modelos se pueden correr
