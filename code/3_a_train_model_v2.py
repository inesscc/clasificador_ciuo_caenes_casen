...
def get_model_artifacts(model_name, embeddings, dim_embeddings):
    ...
    save_pkl(label_encoder, f'../models/artifacts/modelo_2_label_encoder_{model_name}')
    save_pkl(y_test.index, f'../models/artifacts/modelo_2_y_test_index_{model_name}')
    save_pkl(y_train.index, f'../models/artifacts/modelo_2_y_train_index_{model_name}')
    save_pkl(y_test_encoded, f'../models/artifacts/modelo_2_y_test_encoded_{model_name}')
    save_pkl(y_train_encoded, f'../models/artifacts/modelo_2_y_train_encoded_{model_name}')
    ...
    save_pkl(tokenizer_tareas, f'../models/artifacts/modelo_2_tokenizer_tareas_{model_name}')
    ...
    save_pkl(tokenizer_ocupacion, f'../models/artifacts/modelo_2_tokenizer_ocupacion_{model_name}')
    ...
    save_pkl(tokenizer_activ_principal, f'../models/artifacts/modelo_2_tokenizer_activ_principal_{model_name}')

    # Guardar artefactos
    save_pkl(X_test_tareas_pad, f'../models/artifacts/modelo_2_X_test_tareas_pad_{model_name}')
    save_pkl(X_train_tareas_pad, f'../models/artifacts/modelo_2_X_train_tareas_pad_{model_name}')
    save_pkl(X_test_ocupacion_pad, f'../models/artifacts/modelo_2_X_test_ocupacion_pad_{model_name}')
    save_pkl(X_train_ocupacion_pad, f'../models/artifacts/modelo_2_X_train_ocupacion_pad_{model_name}')
    save_pkl(X_test_activ_principal_pad, f'../models/artifacts/modelo_2_X_test_activ_principal_pad_{model_name}')
    save_pkl(X_train_activ_principal_pad, f'../models/artifacts/modelo_2_X_train_activ_principal_pad_{model_name}')
...
def train_model_1(tokenizer_tareas, tokenizer_ocupacion, tokenizer_activ_principal,
                  ...
                  y_train_encoded, model_name, params):
    ...
    x1 = SpatialDropout1D(params['best_params']['dropout_rate'])(x1)
    x1 = LSTM(params['best_params']['lstm_units_tareas'], return_sequences=False)(x1)  
    ...
    x2 = SpatialDropout1D(params['best_params']['dropout_rate'])(x2)
    x2 = LSTM(params['best_params']['lstm_units_ocupacion'], return_sequences=False)(x2)  
    ...
    x3 = SpatialDropout1D(params['best_params']['dropout_rate'])(x3)
    x3 = LSTM(params['best_params']['lstm_units_activ'], return_sequences=False)(x3) 
    ...
    # compile model
    opt = Adam(learning_rate=params['best_params']['learning_rate'])
    model.compile(
        optimizer=opt,
    ...
    model.save(f"../models/modelo_2_{model_name}_lstm.h5")
...
if __name__ == "__main__":
    ...
    # best params 
    with open(f'../models/artifacts/optuna_best_params_{model_name}.pkl', 'rb') as file:
